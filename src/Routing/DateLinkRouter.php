...
use TractorCow\DateLink\IDateLinkRouter;
...
class DateLinkRouter implements IDateLinkRouter
{
    ...
    public function RegisterRoutes()
    {
        ...
        if (!file_exists($cachePath)) {
            return Debug::message(
                'DateLink route cache file could not be found. This can be generated by using /dev/build'
            );
        }
        ...
        // TODO: Debugging... the route does in fact end up here, but that controller isn't called
    ...
    protected function registerRoute($parentLink, $parentID, $yearNumber)
    {
        ...
        Director::config()->update('rules', $routes);
    }

    /**
     * Determines the distinct years in the set of all pages given
     *
     * @param \SilverStripe\ORM\SS_List $pages
     */
