...
namespace TractorCow\DateLink\Extension;

use SilverStripe\CMS\Model\SiteTreeExtension;
use TractorCow\DateLink\DateLink;
...
class DateLinkExtension extends SiteTreeExtension
{
    ...
    {
        $tags .= $this->owner->renderWith('TractorCow/DateLink/Extension/DateLinkExtension_MetaTags');
    }
    ...
    protected function dateEnabled()
    {
        ...
        if ($parentClasses) {
            foreach ($parentClasses as $allowedClass) {
                if ($parent instanceof $allowedClass) {
                    return true;
                }
            }
        }
